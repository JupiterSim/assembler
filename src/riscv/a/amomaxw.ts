...
/** RISC-V RV32A amomax.w instruction. */
export class AMOMAXW extends RType {
  /**
   * Creates a new RV32A amomax.w instruction.
   *
  ...
  constructor(debugInfo: DebugInfo, rd: number, rs1: number, rs2: number) {
    ...
    super(debugInfo, 'amomax.w', 0x2f, rd, 0x2, rs1, rs2, (0b10100 << 2) | aqrl);
  }
}
