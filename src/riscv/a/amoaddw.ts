...
/** RISC-V RV32A amoadd.w instruction. */
export class AMOADDW extends RType {
  /**
   * Creates a new RV32A amoadd.w instruction.
   *
  ...
  constructor(debugInfo: DebugInfo, rd: number, rs1: number, rs2: number) {
    ...
    super(debugInfo, 'amoadd.w', 0x2f, rd, 0x2, rs1, rs2, aqrl);
  }
}
