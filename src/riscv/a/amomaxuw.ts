...
/** RISC-V RV32A amomaxu.w instruction. */
export class AMOMAXUW extends RType {
  /**
   * Creates a new RV32A amomaxu.w instruction.
   *
  ...
  constructor(debugInfo: DebugInfo, rd: number, rs1: number, rs2: number) {
    ...
    super(debugInfo, 'amomaxu.w', 0x2f, rd, 0x2, rs1, rs2, (0b11100 << 2) | aqrl);
  }
}
