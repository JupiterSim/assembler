...
import { PLUSFEXPRContext } from "./RISCVParser";
...
export interface RISCVListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `PLUSFEXPR`
	 * labeled alternative in `RISCVParser.fexpr`.
	 * @param ctx the parse tree
	 */
	enterPLUSFEXPR?: (ctx: PLUSFEXPRContext) => void;
	/**
	 * Exit a parse tree produced by the `PLUSFEXPR`
	 * labeled alternative in `RISCVParser.fexpr`.
	 * @param ctx the parse tree
	 */
	exitPLUSFEXPR?: (ctx: PLUSFEXPRContext) => void;
